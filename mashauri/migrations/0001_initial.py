# Generated by Django 5.0.6 on 2024-08-14 20:27
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dispatching', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='mashauri.dispatch')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='dispatch',
            name='ticketing',
            field=models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='dispatch', to='mashauri.ticket'),
        ),
    ]
